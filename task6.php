...
<body>
	...
	<form method="post" action="down.php" enctype="multipart/form-data">
		...
		Enter Marks:<textarea name="marks" rows="5" cols="40"></textarea><br><br>
		Mobile No.<input type="text" name="mob"><br><br>
		Email-id:<input type="text" name="email"><br><br>
		<input type="submit" name="submit" value="submit & download">
	</form>
